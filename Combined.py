...
class MainWindow(QWidget):
    ...
    def __init__(self, sample_path, output_path, query_path, screen_capture_app):
        super().__init__()
    ...
    def capture_screenshot(self):
        ...
        if self.is_first_wafer_checkbox.isChecked():
            if self.screen_capture_app.preview_image is not None:
                ...
                print(f"Golden Image saved as {self.samplePath}")
            else:
                print("No preview image available. Please select a region first.")
...
if __name__ == '__main__':
    ...
    # 設定樣本影像路徑和輸出路徑
    sample_path = 'screenshots/Golden_image/Golden_image.png'
    ...
    main_window = MainWindow(sample_path, output_path, query_path, screen_capture_app)
    main_window.show()
    sys.exit(app.exec_())
